...
for i=0, nAngles-1 do begin
	for j=0, nUsePeak-1 do begin
		data[i*nUsePeak+j,*] = experiment->getIntensityAtAngle(angleList[sets[i]],peakIndex[j])
...
plotinteractive1D, base, fileindex, data, title = 'intensities vs. image number', xlabel='Image number', ylabel='Intensity', legend=legend
end

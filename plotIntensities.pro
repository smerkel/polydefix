...
pro plotIntensities, base,  data, nSets, nUsePeak, peakIndex, usePeakIndex, legend, wavelength, dynamic, savemovie, filename
...
for i=0, nSets-1 do begin
	for j=0, nUsePeak-1 do begin
		...
		ydata[i,j] = PTR_NEW((data[i])->getIntensity(peakindex[j]))
